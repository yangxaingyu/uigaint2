...
@section('kyc-process')
                ...
                <div class="col-md-6 p-0">
                    <div id="app" class="kyc_form">
                        <form method="POST" action="/kyc-process-step2">
                            ...
                            <div v-if="false" class="kyc_country_dropdown_sect">
                                <div class="kyc_country_dropbox" onclick="toggleDropdown()">
                                    <span>
                                        <img src="/storage/images/flag.png" alt="flag" class="img-fluid">
                                    </span>
                                    <h4>United States</h4>
                                </div>
    ...
    <script>
        ...
        const app = new Vue({
            ...
            methods: {
                getCountry() {
                    axios.get(url + 'demo.json').then(function (response) {
                        app.country = response.data
                        app.countryId = app.country[0].id
                        app.countryIcon = app.country[0].iconPath
