            ...
            <div class="col-lg-5">
                <div class="breadcrumbs-area sec-heading">
                    <div class="sub-inner">
                        ...
                        <img class="heading-left-image" src="/storage/images/icons/steps.png" alt="Steps-Image">
                    </div>
                </div>
            </div>
        ...
        <div class="game-price-item hover-shape-inner">
            <div class="game-price-inner">
                <div class="total-price">
                    <div class="price-inner d-flex mb-45">
                        <div class="image-icon">
                            <img src="/storage/images/project/ninga-image.png" alt="icon-image">
                        </div>
                ...
                <div class="allocation-max text-center">
                    <img src="/storage/images/project/icon-2.png" alt="icon-image">
            ...
            <div class="col-md-6">
                <div class="project-item">
                    <div class="project-info">
                        <h4 class="mb-30">Galaxy War <img src="/storage/images/project/project-heading-image.png" alt="project"></h4>
                    </div>
            ...
            <div class="col-md-6">
                <div class="project-item">
                    <div class="project-info d-flex">
                        <h4 class="mb-20">Token Info <img src="/storage/images/project/project-heading-image.png" alt="project"></h4>
                    </div>
                    <div class="project-content">
                        <div class="project-media">
                            <ul class="project-listing">
                                ...
                                <li>Address <span><img src="/storage/images/project/icon.png" alt="project">0x22d40020282f9c8</span></li>
            ...
            <div class="col-md-4 sidebar is-affixed" style="height: 640px; position: relative;">
                <div class="project-summary-menu project_summary_menu_BgGridient sidebar__inner" id="myScrollspy" style="position: fixed; top: 20px; left: 52px; width: 376px;">
                    <div id="ProjectSammeryTabs" class="project_summary_tabs_sect">
                        <div class="active project-summary-tab-btn  project-summary-tab-btn1" data-target="#project_summary"><a href="#project_summary">Project Summary <img src="/storage/images/project/menu-image.png" alt="project"></a></div>

                        <div class="project-summary-tab-btn project-summary-tab-btn2" data-target="#Schedule"><a href="#Schedule">Schedule <img src="/storage/images/project/menu-image.png" alt="project"></a></div>

                        <div class="project-summary-tab-btn project-summary-tab-btn3" data-target="#Comparison"><a href="#Comparison">Comparison <img src="/storage/images/project/menu-image.png" alt="project"></a></div>

                        <div class="project-summary-tab-btn project-summary-tab-btn4" data-target="#Tokenomics"><a href="#Tokenomics">Tokenomics <img src="/storage/images/project/menu-image.png" alt="project"></a></div>

                        <div class="project-summary-tab-btn project-summary-tab-btn5" data-target="#Roadmap"><a href="#Roadmap">Roadmap <img src="/storage/images/project/menu-image.png" alt="project"></a></div>

                        <div class="project-summary-tab-btn project-summary-tab-btn6" data-target="#Team_Members"><a href="#Team_Members">Team Member<img src="/storage/images/project/menu-image.png" alt="project"></a></div>

                        <div class="project-summary-tab-btn project-summary-tab-btn7" data-target="#Investors"><a href="#Investors">Investors<img src="/storage/images/project/menu-image.png" alt="project"></a></div>
                    </div>
                </div>
            </div>
                ...
                <div class="project_summarySectScrllab">
                    <div class="project-summary-content" id="project_summary">
                        <div class="project-summary-information">
                            ...
                            <div class="project-video-area">
                                <img src="/storage/images/project/project-video.jpg" alt="Project-image">
                    ...
                    <div class="ScrollSpy_sections" id="Tokenomics">
                        ...
                        <div class="project-service align-items-center">
                            <div class="project-image">
                                <img src="/storage/images/project/explore-image.png" alt="Project-image">
                            </div>
                            <div class="project-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="project_details_road_map_content">
                                        <h4>Q1 2021</h4>
                                        <ul>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Launch on GamFi</li>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Seed round</li>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Listing on CEX</li>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Development of NFT Marketplace</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="project_details_road_map_content">
                                        <h4>Q2 2021</h4>
                                        <ul>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>First NFT pre-orders</li>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Launch of the GAME coin</li>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Full-scale platform launch</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="project_details_road_map_content">
                                        ...
                                        <ul>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Launch on GamFi</li>
                                            <li><span><img src="/storage/images/kycimg/RMcheckicon.svg" alt="icon" class="img-fluid"></span>Auction system integration. </li>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>Mobile app for iOS and Android. </li>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>Development of NFT Marketplace</li>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>Game launch</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="project_details_road_map_content">
                                        ...
                                        <ul>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>Application for crypto exchange</li>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>Private round</li>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>New team member added</li>
                                            <li><span><img src="/storage/images/kycimg/munies.svg" alt="icon" class="img-fluid"></span>Team expansion</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="project_details_team_members_sect">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Berneice Tran</h5>
                                        <h6>Director</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image2.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Loreo Zina</h5>
                                        <h6>Co-Founder</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image3.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Robert Zeo</h5>
                                        <h6>Game Designer</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image4.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Monika Deo</h5>
                                        <h6>Marketter</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image5.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Sweety Neo</h5>
                                        <h6>Seo Enginneer</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image6.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Tran Neolas</h5>
                                        <h6>Enginneer</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image7.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>John Deo</h5>
                                        <h6>UI Designer</h6>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="project_details_team_members_card">
                                        <div class="team_members_img">
                                            <img src="/storage/images/team/team-image8.png" alt="img" class="img-fluid">
                                        </div>
                                        <h5>Zina Doom</h5>
                                        <h6>Developer</h6>
                                    </div>
                    ...
                    <div class="ScrollSpy_sections" id="Investors">
                        ...
                        <div class="list_investors_list">
                            <ul>
                                <li class="first"><img src="/storage/images/partner/1.png" alt="logo" class="img-fluid"></li>
                                <li class="second"><img src="/storage/images/partner/2.png" alt="logo" class="img-fluid"></li>
                                <li class="third"><img src="/storage/images/partner/3.png" alt="logo" class="img-fluid"></li>
                                <li class="last"><img src="/storage/images/partner/4.png" alt="logo" class="img-fluid"></li>
                                <li class="first"><img src="/storage/images/partner/6.png" alt="logo" class="img-fluid"></li>
                                <li class="second"><img src="/storage/images/partner/7.png" alt="logo" class="img-fluid"></li>
                                <li class="third"><img src="/storage/images/partner/8.png" alt="logo" class="img-fluid"></li>
                                <li class="last"><img src="/storage/images/partner/5.png" alt="logo" class="img-fluid"></li>
                            </ul>
                        </div>
                    </div>
                </div>
