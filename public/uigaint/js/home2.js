...
console.log(roadmap_v2_section)
console.log(roadmap_v2_section.length)
if (1 || roadmap_v2_section.length) {
...
console.log(project_pools_sect)
console.log(project_pools_sect.length)
if (1 || project_pools_sect.length) {
